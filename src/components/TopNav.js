...
export default function TopNav() {
    ...
    console.log(sideNav);
    return (
        <div className='mx-w-[1520] mx-auto flex justify-between items-center p-5 '>
            <div className='flex items-center'>
                ...
                <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Yum
                    <span className='text-orange-700 font-bold ml-2'>Eats</span></h1>

                <div className='hidden lg:flex items-center bg-gray-200 rounded-full  p-1 text-[14px]'>



                    <p className='bg-orange-700 text-white p-2  rounded-full font-bold'>Free</p>
            ...
            <div className='bg-gray-200 rounded-full items-center px-2 flex w-[200px] sm:w-[400] lg:w-[500px]  '>

                <AiOutlineSearch size={25} />

                <input className='bg-transparent p-2 w-full focus:outline-none ' type='text' placeholder='Search Meal'></input>
            </div>

            <button className='bg-orange-700 text-white py-2 md:flex item-center rounded-full'>
